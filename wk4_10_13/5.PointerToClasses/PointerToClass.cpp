...
// Author: K. Sung
// Purpose:
//     Illustrate pointers and references to simple class. This is identical to 4.PointerToStruct.cpp except, 
//     IntPair is now a class with everything public
//
// Notice that, except for changing how the class is defined, the rest of the code is identical to 4.PointerToStruct.cpp
// This is because in C++, the only difference between struct and class is the default access level
// In struct, members are public by default, while in class, members are private by default
// Here, we explicitly declare everything as public in the class definition
//
#include <iostream>
using namespace std;
